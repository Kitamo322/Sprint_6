...
class OrderData:
    NAME = ['Иван', 'Евгений', 'Пётр', 'Валера', 'Костик']
    SURNAME = ['Генералов', 'Иванов', 'Петров', 'Сидоров']
    ADDRESSE = ['15-я парковая, дом 24', '3-я улица Строителей, дом 25', 'Сиреневый бульвар, дом 36']
    STATION = ['Первомайская', 'Университет', 'Партизанская', 'Измайловская']
    RENTAL_PERIOD = ['сутки', 'двое суток', 'пятеро суток']
    COLOR = ['black', 'grey']
    COMMENT = ['Везите скорее, хочу кататься!', 'Въезд во двор под шлагбаум', 'Просьба позвонить за час']
